...
type
  Tfrmven_nfe = class(TForm)
    ...
    TAB_NATCST_CSOSN: TIBStringField;
    TAB_NATCST_CSOSNCRED: TIBStringField;
    ...
    TAB_NATINDTOT: TSmallintField;
    TAB_NATPREDBC: TIBBCDField;
    TAB_NATPREDBCST: TIBBCDField;
    TAB_NATPREDBCEFET: TIBBCDField;
    TAB_NATINFADCAD: TMemoField;
    TAB_NATIP: TIBStringField;
    TAB_NATHOST: TIBStringField;
    TAB_NATFLAG: TSmallintField;
    TAB_NATTPOP: TSmallintField;
    TAB_NATDEOP: TIBStringField;
    TAB_NATNOOP: TIBStringField;
    ...
    SQLPKSEdicao: TIBSQL;
    DBGEdicaoENABLECONTROLS: TdxDBGridMaskColumn;
    DBGEdicaoC_ID: TdxDBGridColumn;
    EdicaoID: TLargeintField;
    EdicaoNFE_CDEP: TSmallintField;
    EdicaoNFE_CCAB: TLargeintField;
    EdicaoNFE_IDEV: TLargeintField;
    EdicaoNFE_CDEV: TSmallintField;
    ...
    EdicaoNFE_ITEMPED: TIBStringField;
    EdicaoNFE_XPED: TIBStringField;
    EdicaoNFE_ORIG: TSmallintField;
    EdicaoNFE_CST: TIBStringField;
    EdicaoNFE_IPRO: TLargeintField;
    EdicaoNFE_CART: TIBStringField;
    ...
    EdicaoNFE_XPROX: TIBStringField;
    EdicaoNFE_DCOR: TIBStringField;
    EdicaoNFE_COMP: TIBStringField;
    EdicaoNFE_UCOM: TIBStringField;
    EdicaoNFE_UTRIB: TIBStringField;
    EdicaoNFE_UQTDE: TIBBCDField;
    EdicaoNFE_UQVOL: TIBBCDField;
    EdicaoNFE_UESP: TIBStringField;
    EdicaoNFE_PESO: TIBBCDField;
    EdicaoNFE_PSCN: TIBBCDField;
    EdicaoNFE_PSBR: TIBBCDField;
    EdicaoNFE_PSLQ: TIBBCDField;
    EdicaoNFE_METR: TIBBCDField;
    EdicaoNFE_GRAM: TIBBCDField;
    EdicaoNFE_REND: TIBBCDField;
    ...
    EdicaoNFE_VUNMAO: TFloatField;
    EdicaoNFE_INDMAO: TSmallintField;
    ...
    EdicaoNFE_MODBCST: TIBStringField;
    ...
    EdicaoNFE_INDDEDUZDESON: TIBStringField;
    ...
    EdicaoNFE_VBCOFINS: TIBBCDField;
    EdicaoNFE_PCOFINS: TIBBCDField;
    EdicaoNFE_VCOFINS: TIBBCDField;
    EdicaoNFE_VBCOFINSST: TIBBCDField;
    ...
    EdicaoNFE_VIIIMP: TIBBCDField;
    EdicaoNFE_VIOFIMP: TIBBCDField;
    EdicaoNFE_VMULTA: TIBBCDField;
    EdicaoNFE_VAFRMM: TIBBCDField;
    EdicaoNFE_CMUNFGISSQN: TIBStringField;
    EdicaoNFE_VBCISSQN: TIBBCDField;
    EdicaoNFE_VALIQISSQN: TIBBCDField;
    EdicaoNFE_VISSQN: TIBBCDField;
    EdicaoNFE_CLISTSERV: TIntegerField;
    EdicaoNFE_MVAST: TIBBCDField;
    EdicaoNFE_VI04: TIBBCDField;
    EdicaoNFE_VI07: TIBBCDField;
    EdicaoNFE_VI12: TIBBCDField;
    EdicaoNFE_VI18: TIBBCDField;
    EdicaoNFE_CMUNFGIBS_B12A: TIBStringField;
    EdicaoNFE_TPNFDEBITO_B25_1: TIBStringField;
    EdicaoNFE_TPNFCREDITO_B25_2: TIBStringField;
    EdicaoNFE_TPENTEGOV_B32: TIBStringField;
    EdicaoNFE_PREDUTOR_B33: TIBBCDField;
    EdicaoNFE_TPOPERGOV_B34: TIBStringField;
    EdicaoNFE_CSTIS_UB02: TIBStringField;
    EdicaoNFE_CCLASSTRIBIS_UB03: TIBStringField;
    EdicaoNFE_VBCIS_UB05: TIBBCDField;
    EdicaoNFE_PIS_UB06: TIBBCDField;
    EdicaoNFE_PISESPEC_UB07: TIBBCDField;
    EdicaoNFE_UTRIB_UB09: TIBStringField;
    EdicaoNFE_QTRIB_UB10: TIBBCDField;
    EdicaoNFE_VIS_UB11: TIBBCDField;
    EdicaoNFE_CST_UB13: TIBStringField;
    EdicaoNFE_CCLASSTRIB_UB14: TIBStringField;
    EdicaoNFE_INDDOACAO_UB14A: TIBStringField;
    EdicaoNFE_VBC_UB16: TIBBCDField;
    EdicaoNFE_PIBS_UB18: TIBBCDField;
    EdicaoNFE_PDIF_UB22: TIBBCDField;
    EdicaoNFE_VDIF_UB23: TIBBCDField;
    EdicaoNFE_VDEVTRIB_UB25: TIBBCDField;
    EdicaoNFE_PREDALIQ_UB27: TIBBCDField;
    EdicaoNFE_PALIQEFET_UB28: TIBBCDField;
    EdicaoNFE_VIBSUF_UB35: TIBBCDField;
    ...
    EdicaoNFE_REPR: TIBStringField;
    EdicaoNFE_UF: TIBStringField;
    EdicaoNFE_UFST: TIBStringField;
    EdicaoNFE_FRET: TIBStringField;
    EdicaoNFE_TIPO: TIBStringField;
    EdicaoNFE_STAV: TIBStringField;
    EdicaoNFE_INFADTRIB: TIBStringField;
    EdicaoNFE_INFADPROD: TIBStringField;
    EdicaoENABLECONTROLS: TSmallintField;
    ...
    procedure EdicaoNFE_NCMValidate(Sender: TField);
    ...
    procedure EdicaoNFE_UFValidate(Sender: TField);
...
uses uPrincipal, bPrincipal,
  pemail, pctr_rom,
  pctr_nfe, pimporta_geral, pPesquisaCodigoMunicipal,
  pNFeConsultaSefaz;
...
begin
  ...
  try
    ...
    begin
      UnregisterEvents;
      Events.Add(TRIM(oREPZero(RECDefault.FB_Event,'_',RECParametros.EP_ID,3)));
      Events.Add(TRIM(oREPZero(RECDefault.FB_Event,'_',RECParametros.EP_ID,3) + IFThen(Pos(RECUsuarios.Grupo,'VENEXPPCPQLDCOMCRI') > 0,'_' + RECUsuarios.ID,'')));
      RegisterEvents;
    end;
  except
    on E: Exception do
...
begin
  ...
  begin
    if (Edicao.State in [dsInsert,dsEdit]) and (not oEmpty(EdicaoNFE_VPROD.AsFloat)) then
        Edicao.Post;
...
begin
  ...
  begin
    ...
    { Consumidor Final }
    if (RECParametros.NFE_CRT = 3) and (IEIndFinal.Text = '1') and (IETPNF.Text = '1') and (PEUF.Text <> 'EX') and (PEUF.Text <> RECParametros.LOG_UF) then
    ...
    begin
      ...
      try
        ...
        begin
          if EdicaoNFE_QCOM.AsFloat   = 0 then sWarning := 'Quantidade não Informada !';
          if EdicaoNFE_VUNCOM.AsFloat = 0 then sWarning := 'Valor Unitário não Informado !';


          if (EdicaoNFE_NFCI.AsString = EmptyStr) and
             (EdicaoNFE_ORIG.AsString = '5'     ) and (EdicaoNFE_CST.AsString = '00') then sWarning := 'FCI não Informado !';


          if not oEmpty(sWarning) then
          begin
            sWarning := sWarning +#13+'Item: '+EdicaoNFE_ITEMPED.AsString;
            Break;
          end;
          ...
          if IEFinNFe.Text <> '2' then
             ...
             begin
               ...
               oException(DBGEdicao,'NCM não Informado ou Incorreto !'+#13+#13+
                                 'Item '+EdicaoNFE_ITEMPED.AsString+' - '+EdicaoNFE_CPROD.AsString+'.');
             end;
        ...
        if not oEmpty(sWarning) then
           if (EdicaoNFE_ORIG.AsString = '5') and (EdicaoNFE_CST.AsString = '00') then
               oErro(handle,sWarning)
           else
               oException(DBGEdicao,sWarning);
        Edicao.First;
      end;
      ...
      try
        ...
        begin
          ...
          begin
            ...
            EdicaoNFE_UFDESEMB.Value     := PEUFDesemb.Text;
            ...
            EdicaoNFE_UFTerceiro.Value   := PEUFTerceiro.Text;
...
begin
  ...
  SBMain.Panels[1].Text :=  AssinaArquivoXML(PChar('C:\Sheild\NotaFiscal\NFe\arquivos\'+chNFe+'.xml'),'infNFe');
  SBMAin.Refresh;
  SleepEx(500,False);

  BRet := (LeftStr(SBMain.Panels[1].Text,1) = 'A');
  if not BRet then
     SBMain.Panels[0].Text := 'Falha na assinatura';
     SBMAin.Refresh;

  { Valida }
  if BRet then
  begin
    SBMain.Panels[0].Text := 'Aguarde, validando assinatura ...';
    SBMain.Panels[1].Text := EmptyStr;
    SBMain.Refresh;
...
begin
  ...
  SBMain.Panels[0].Text := 'Aguarde, Transmitindo arquivo XML ...';
  SBMain.Panels[1].Text := NfeRetAutorizacao(protNFe);
  SBMain.Refresh;
  ...
  try
    ...
    SBMain.Panels[0].Text := 'Pronto';
    SBMain.Panels[1].Text := Trim(FrmNFeConsultaSefaz.IEdStat.Descriptions[FrmNFeConsultaSefaz.IEdStat.Values.IndexOf(FrmNFeConsultaSefaz.IEdStat.Text)]) + #13 + #13 +
                             Trim(FrmNFeConsultaSefaz.EMConsulta.Text);
       ...
       try
         ...
         begin
           ...
           begin
             ...
             EdicaoNFE_ITEMPED.Value  := oStrZero(NFeNFE_ITEMPED.AsInteger,5);
             ...
             EdicaoNFE_QCOM.Value     := NFeNFE_QCOM.AsFloat;
         ...
         begin
           ...
           if EdicaoNFE_CCAB.AsInteger = 99999 then
              while not Edicao.Eof do
              begin
                Edicao.Edit;
                EdicaoNFE_CPROD.Value    := CECDNF.Text+'/'+EdicaoNFE_ITEMPED.AsString;
                EdicaoNFE_VUNCOM.AsFloat := IFThen(EdicaoNFE_VUNCOM.AsFloat <> EdicaoNFE_VPROD.AsFloat / EdicaoNFE_QCOM.AsFloat,EdicaoNFE_VPROD.AsFloat / EdicaoNFE_QCOM.AsFloat,EdicaoNFE_VUNCOM.AsFloat);
                Edicao.Post;
                Edicao.Next;
              end;
         end else
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('SELECT   FIRST 1 NFE_CNAT  FROM '+SLPrincipal.Values['nfe_cab']);
  ...
  begin
    ...
    if BCalc then
       try
         ...
         while not Edicao.Eof do
         begin
           if tab_natNAT_CNAT.AsString <> EdicaoNFE_CFOP.AsString then
           begin
             Edicao.Edit;
             EdicaoNFE_CFOP.Value := tab_natNAT_CNAT.AsString;
             Edicao.Post;
           end;
           Edicao.Next;
         end;
...
begin
  ...
  begin
    Close;
    SQL.Clear;
    SQL.Add('SELECT   FIRST 1 NFE_CTRA  FROM '+SLPrincipal.Values['nfe_cab']);
    SQL.Add('WHERE    NFE_CFAV = '''+CEIDCD.Text+'''');
    SQL.Add('ORDER BY CDNF DESC');
    ExecQuery;
  ...
  try
    ...
    begin
      ...
      if x = 2 then
         ...
         SBMain.Panels[1].Text := 'Falha na geração do lote !';
         SBMain.Refresh;
    end else
    begin
      ...
      SBMain.Panels[3].Text := Trim(RightStr(SBMain.Panels[1].Text,Length(SBMain.Panels[1].Text) - Pos('#',SBMain.Panels[1].Text)));
      SBMain.Refresh;
    end;
  finally
    Screen.cursor := crDefault;
...
begin
  try
    ...
    begin
      ...
      InfAd.Add(Trim('Decreto no 62.560/2017 (DOE de 06.05.2017) = '+FormatFloat('#,0.00%',EdicaoNFE_PREDBC.AsFloat))+'|');
    end;
...
begin
  ...
  EdicaoNFE_VUNCOM.Value := FBird.FBCAD_PROVPRC_PAD.AsFloat;
  EdicaoNFE_VUNPAD.Value := FBird.FBCAD_PROVPRC_PAD.AsFloat;

  EdicaoNFE_IPRO.Value   := FBird.FBCAD_PROId.AsInteger;
  EdicaoNFE_CPROD.Value  := FBird.FBCAD_PROSKU.AsString;
  EdicaoNFE_XPROD.Value  := TRIM(FBird.FBCAD_PRODECP.AsString+' '+FBird.FBCAD_PRODGCP.AsString);
  EdicaoNFE_UCOM.Value   := FBird.FBCAD_PROUCOM.AsString;
  EdicaoNFE_NCM.Value    := FBird.FBCAD_PRONCM.AsString;
  EdicaoNFE_PIPI.Value   := FBird.FBCAD_PROPIPI.AsFloat;
  EdicaoNFE_CEST.Value   := FBird.FBCAD_PROCEST.AsString;
  EdicaoNFE_EXTIPI.Value := FBird.FBCAD_PROEXTIPI.AsString;

  if LeftStr(EdicaoNFE_CFOP.AsString,1) = '7' then
  EdicaoNFE_UTRIB.Value := FBird.FBCAD_PROUTRIB.AsString;
  EdicaoNFE_ORIG.Value  := FBird.FBCAD_PROORIG.AsInteger;

  EdicaoNFE_REPR.Value   := 'R';//FBird.FBCAD_PROPRO_REPR.AsString;
  EdicaoNFE_CEAN.Value   := FBird.FBCAD_PROCEAN.AsString;
  EdicaoNFE_STAV.Value   := FBird.FBCAD_PROREST.AsString;

  EdicaoNFE_PESO.Value := FBird.FBCAD_PROPESO.AsFloat;
  EdicaoNFE_PSCN.Value := FBird.FBCAD_PROPSCN.AsFloat;
  EdicaoNFE_METR.Value := FBird.FBCAD_PROMETRO.AsFloat;
  EdicaoNFE_REND.Value := FBird.FBCAD_PROREND.AsFloat;
  EdicaoNFE_UQTDE.Value := FBird.FBCAD_PROUQTDE.AsInteger; { RICARDO }

  EdicaoNFE_COMP.Value      := Trim(FBird.FBCAD_PROCMP_PAD.AsString);
  EdicaoNFE_INFADPROD.Value := Trim(FBird.FBCAD_PROCMP_PAD.AsString);
  if not oEmpty(EdicaoNFE_INFADPROD.AsString) then
     EdicaoNFE_INFADPROD.Value := 'COMPOSICAO: '+EdicaoNFE_INFADPROD.AsString;

  if ((FBird.FBCAD_PROUQVOL.AsFloat > 0) and (not oEmpty(FBird.FBCAD_PROUESP.AsString))) then
       EdicaoNFE_INFADPROD.Value := EdicaoNFE_INFADPROD.AsString+#13+'CONTEUDO: '+FBird.FBCAD_PROUQVOL.AsString+FBird.FBCAD_PROUESP.AsString
  else
     if Pos(LeftStr(FBird.FBCAD_PROUCOM.AsString,1),'KMY') = 0 then
        if FBird.FBCAD_PROMETRO.AsFloat > 0 then
           EdicaoNFE_INFADPROD.Value := EdicaoNFE_INFADPROD.AsString+#13+'CONTEUDO: '+FormatFloat('0.00M',FBird.FBCAD_PROMETRO.AsFloat);
  ...
  try
    ...
    try
      ...
      begin
        ...
        SPEdicao.ParamByName('CART').Value           := EdicaoNFE_CART.AsString;
        ...
        SPEdicao.ParamByName('DCOR').Value           := EdicaoNFE_DCOR.AsString;
        SPEdicao.ParamByName('XPROD').Value          := EdicaoNFE_XPROD.AsString;
        SPEdicao.ParamByName('INFADPROD').Value      := EdicaoNFE_INFADPROD.AsString;
        SPEdicao.ParamByName('UCOM').Value           := EdicaoNFE_UCOM.AsString;
        SPEdicao.ParamByName('QCOM').Value           := EdicaoNFE_QCOM.AsFloat;
        SPEdicao.ParamByName('RCOM').Value           := EdicaoNFE_RCOM.AsInteger;

        SPEdicao.ParamByName('PSCN').Value           := EdicaoNFE_PSCN.AsFloat;
        ...
        SPEdicao.ParamByName('ITEMPED').Value        := EdicaoNFE_ITEMPED.AsString;
        SPEdicao.ParamByName('ORIG').Value           := EdicaoNFE_ORIG.AsInteger;
        ...
        SPEdicao.ParamByName('MVAST').Value          := EdicaoNFE_MVAST.AsFloat;
        ...
        SPEdicao.ParamByName('VIIIMP').Value         := EdicaoNFE_VIIIMP.AsFloat;
        SPEdicao.ParamByName('VIOFIMP').Value        := EdicaoNFE_VIOFIMP.AsFloat;
        ...
        SPEdicao.ParamByName('VBCOFINS').Value       := EdicaoNFE_VBCOFINS.AsFloat;
        SPEdicao.ParamByName('PCOFINS').Value        := EdicaoNFE_PCOFINS.AsFloat;
        SPEdicao.ParamByName('VCOFINS').Value        := EdicaoNFE_VCOFINS.AsFloat;
        SPEdicao.ParamByName('VBCOFINSST').Value     := EdicaoNFE_VBCOFINSST.AsFloat;
        ...
        SPEdicao.ParamByName('VBCISSQN').Value       := EdicaoNFE_VBCISSQN.AsFloat;
        SPEdicao.ParamByName('VALIQISSQN').Value     := EdicaoNFE_VALIQISSQN.AsFloat;
        SPEdicao.ParamByName('VISSQN').Value         := EdicaoNFE_VISSQN.AsFloat;
        SPEdicao.ParamByName('CMUNFGISSQN').Value    := EdicaoNFE_CMUNFGISSQN.AsString;
        SPEdicao.ParamByName('CLISTSERV').Value      := EdicaoNFE_CLISTSERV.AsInteger;
...
begin
  if oYesNo(handle,'Excluir Item Nº '+EdicaoNFE_ITEMPED.AsString+' ?') = mrNo then
     Abort;
...
begin
  ...
  if EdicaoNFE_PICMSST.AsCurrency > 0 then
  DBGEdicao.Bands[6].Visible := True;

  { NFCI }
  if EdicaoNFE_NFCI.AsString <> EmptyStr then
...
begin
  ...
  begin
    ...
    if (BMRecord = Nil) or (Edicao.Fields[0].IsNull) then Edicao.last else
...
begin
  EdicaoID.Value       := 0;
  EdicaoNFE_IDEV.Value := 0;
  EdicaoNFE_CDEV.Value := 19;

  EdicaoNFE_CDNF.Value   := Trunc(CECDNF.Value);
  EdicaoNFE_CFOP.Value   := LeftStr(cbcnat.Text,4);
  EdicaoNFE_INDTOT.Value := 1;
  EdicaoNFE_MODBC.Value  := 3;

  EdicaoNFE_REPR.Value   := 'R';
  ...
  begin
    ...
    ExecQuery;
    EdicaoNFE_ITEMPED.Value := oStrZero(Current.Vars[0].AsInteger + 1,5);
  end;

  EdicaoEnableControls.Value := 1;
  EdicaoFLAG.Value := 0;
end;
...
begin
  ...
  begin
    ...
    { Peso Líquido}
    if  LeftStr(EdicaoNFE_UCOM.AsString,1) = 'K' then EdicaoNFE_PSLQ.Value := EdicaoNFE_QCOM.AsFloat else
    if (LeftStr(EdicaoNFE_UCOM.AsString,1) = 'M') and (EdicaoNFE_REND.AsFloat > 0) then
        EdicaoNFE_PSLQ.Value := EdicaoNFE_QCOM.AsFloat / EdicaoNFE_REND.AsFloat else
    if (LeftStr(EdicaoNFE_UCOM.AsString,1) = 'M') and (EdicaoNFE_METR.AsFloat > 0) and (EdicaoNFE_PESO.AsFloat > 0) then
        EdicaoNFE_PSLQ.Value := (EdicaoNFE_QCOM.AsFloat * EdicaoNFE_PESO.AsFloat) / EdicaoNFE_METR.AsFloat else
    if  EdicaoNFE_PESO.AsFloat > 0 then
        EdicaoNFE_PSLQ.Value := (EdicaoNFE_PESO.AsFloat * EdicaoNFE_QCOM.AsFloat) / IFThen(EdicaoNFE_UQTDE.AsFloat > 0,EdicaoNFE_UQTDE.AsFloat,1);

    { Peso Bruto }
    EdicaoNFE_PSBR.Value := EdicaoNFE_PSLQ.AsFloat + (EdicaoNFE_RCOM.AsInteger * IFThen(EdicaoNFE_PSCN.AsFloat > 0,EdicaoNFE_PSCN.AsFloat,0.02));
...
begin
  ...
  begin
    ...
    ExecQuery;
    i := SQLPKSEdicao.Fields[0].AsInteger;
  end;
  ...
  begin
    Edicao.Edit;
    EdicaoNFE_VFRETE.Value := RoundTO(CEVFRT.Value / i,-2);
    Edicao.Post;
    Edicao.Next;
  end;
  Edicao.Last;

  if (RoundTO(EdicaoNFE_VFRETE.AsFloat,-2)*i) <> (CEVFRT.Value) then
  begin
    Edicao.Edit;
    if (RoundTO(EdicaoNFE_VFRETE.AsFloat,-2)*i) > (CEVFRT.Value) then
       EdicaoNFE_VFRETE.Value := EdicaoNFE_VFRETE.AsFloat - ((RoundTO(EdicaoNFE_VFRETE.AsFloat,-2)*i)-CEVFRT.Value)
    else
       EdicaoNFE_VFRETE.Value := EdicaoNFE_VFRETE.AsFloat + (CEVFRT.Value-(RoundTO(EdicaoNFE_VFRETE.AsFloat,-2)*i));
    Edicao.Post;
  end;
end;
...
begin
  ...
  begin
    Edicao.Edit;
    EdicaoNFE_VSEG.Value := RoundTO(CEVSEG.Value / i,-2);
    Edicao.Post;
    Edicao.Next;
  end;
  Edicao.Last;

  if (RoundTO(EdicaoNFE_VSEG.AsFloat,-2)*i) <> (CEVSEG.Value) then
  begin
    Edicao.Edit;
    if (RoundTO(EdicaoNFE_VSEG.AsFloat,-2)*i) > (CEVSEG.Value) then
      EdicaoNFE_VSEG.Value := EdicaoNFE_VSEG.AsFloat - ((RoundTO(EdicaoNFE_VSEG.AsFloat,-2)*i)-CEVSEG.Value)
    else
      EdicaoNFE_VSEG.Value := EdicaoNFE_VSEG.AsFloat + (CEVSEG.Value-(RoundTO(EdicaoNFE_VSEG.AsFloat,-2)*i));
    Edicao.Post;
  end;
end;
...
begin
  ...
  if EdicaoEnableControls.AsInteger = 1 then
  begin
    if oYesNo(handle,'Desabilitar Cálculos Tributários ?') = mrYes then
    begin
      Edicao.Edit;
      EdicaoEnableControls.Value := 0;
      Edicao.Post;
    end;
  end else
...
begin
  if not ASelected then
     if ANode.Values[DBGEdicaoEnableControls.Index] = 0 then
     begin
         AColor      := clGrayText;
         AFont.Color := clHighLightText;
     end else
     begin
       if (AColumn = DBGEdicaoNFE_ITEMPED) or (AColumn = DBGEdicaoNFE_XPED) or (AColumn = DBGEdicaoNFE_CPROD) then
       begin
         AColor      := clBtnFace;
         AFont.Color := clBlack;
       end;
...
begin
  ...
  begin
    ...
    begin
      ...
      EdicaoNFE_INFADPROD.Value := EmptyStr;
      EdicaoNFE_COMP.Value      := EmptyStr;
...
begin
  if (IEFinNFe.Text = '2') or (IEFinNFe.Text = '3') then
  begin
    EdicaoNFE_PICMS.Value := StrToFloat(DBGEdicao.EditingText);
    if EdicaoNFE_PICMS.AsFloat > 0 then
    begin
      EdicaoNFE_VBC.Value   := IFThen(EdicaoNFE_VBC.AsFloat = 0,StrToFloat(NewVBC),EdicaoNFE_VBC.AsFloat);
      EdicaoNFE_VICMS.Value := RoundTO((EdicaoNFE_PICMS.AsFloat*EdicaoNFE_VBC.AsFloat)/100,-2);
    end;
  end;
end;
...
begin
  if (IEFinNFe.Text = '2') or (IEFinNFe.Text = '3') then
  begin
    EdicaoNFE_VICMS.Value := StrToFloat(DBGEdicao.EditingText);
    if EdicaoNFE_VICMS.AsFloat > 0 then
    begin
      EdicaoNFE_PICMS.Value := IFThen(EdicaoNFE_PICMS.AsFloat = 0,StrToFloat(NewVBC),EdicaoNFE_PICMS.AsFloat);
      EdicaoNFE_VBC.AsFloat := RoundTO((EdicaoNFE_VICMS.AsFloat/EdicaoNFE_PICMS.AsFloat)*100,-2);
    end;
  end;
end;
...
begin
  if (IEFinNFe.Text = '2') or (IEFinNFe.Text = '3') then
  begin
    EdicaoNFE_VBCIPI.Value := StrToFloat(DBGEdicao.EditingText);
    if EdicaoNFE_VBCIPI.AsFloat > 0 then
    begin
      EdicaoNFE_PIPI.Value   := IFThen(EdicaoNFE_PIPI.Value = 0,StrToFloat(NewPIPI),EdicaoNFE_PIPI.AsFloat);
...
begin
  if (IEFinNFe.Text = '2') or (IEFinNFe.Text = '3') then
  begin
    EdicaoNFE_PIPI.Value   := StrToFloat(DBGEdicao.EditingText);
    if EdicaoNFE_PIPI.AsFloat > 0 then
    begin
      EdicaoNFE_VBCIPI.Value := IFThen(EdicaoNFE_VBCIPI.AsFloat = 0,StrToFloat(NewVBCIPI),EdicaoNFE_VBCIPI.AsFloat);
      EdicaoNFE_VIPI.Value   := RoundTO((EdicaoNFE_PIPI.AsFloat*EdicaoNFE_VBCIPI.AsFloat)/100,-2);
    end;
  end;
end;
...
begin
  if (IEFinNFe.Text = '2') or (IEFinNFe.Text = '3') then
  begin
    EdicaoNFE_VIPI.Value   := StrToFloat(DBGEdicao.EditingText);
    if EdicaoNFE_VIPI.AsFloat > 0 then
    begin
      EdicaoNFE_PIPI.Value     := IFThen(EdicaoNFE_PIPI.AsFloat = 0,StrToFloat(NewVBCIPI),EdicaoNFE_PIPI.AsFloat);
      EdicaoNFE_VBCIPI.AsFloat := RoundTO((EdicaoNFE_VIPI.AsFloat/EdicaoNFE_PIPI.AsFloat)*100,-2);
    end;
  end;
end;
...
procedure Tfrmven_nfe.DBGEdicaoNFE_VPRODValidate(Sender: TObject;
  var ErrorText: String; var Accept: Boolean);
begin
  EdicaoNFE_VPROD.Value := oTextToValor(DBGEdicao.EditingText);
end;
...
begin
  if LeftStr(cbcnat.Text,1) = '3' then
     try
       ...
       begin
         REC_SHE_DEF.IDPK := '0';
         REC_SHE_DEF.CDPK := EdicaoNFE_CPROD.AsString;
         ...
         SPEdicao.ParamByName('INFADTEC').Value := EdicaoNFE_XPROX.AsString;
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        Edicao.Edit;
        EdicaoNFE_CPROD.AsString := CECDNF.Text+'/'+EdicaoNFE_ITEMPED.AsString;
        Edicao.Post;
        Edicao.Next;
      end;
    end;
...
begin
  if Edicao.RecNo > 0 then
     try
       ...
       while not Edicao.Eof do
       begin
         if EdicaoNFE_VPROD.AsFloat >= RVDUP then
         begin
           Edicao.Edit;
           EdicaoNFE_VDESC.Value := IFThen(nRecNo > Edicao.RecNo,RVDUP,RVSLD);
           Edicao.Post;

           CEVDSC.Value := CEVDSC.Value + EdicaoNFE_VDESC.AsFloat;
         end;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          DUP_001NFE_DVEN.Value := uRETDTVencimento(incDay(DEdhEmi.Date,TAB_PAG.Fields[i + 1].Value));
        end else
        begin
          DUP_001NFE_DNFE.Value := DEdhEmi.Date;
          DUP_001NFE_DVEN.Value := uRETDTVencimento(incDay(DEdhSaiEnt.Date,TAB_PAG.Fields[i + 1].Value));
        end;
...
begin
  ...
  begin
    ...
    { Descrição XML }
    PNLXPROX.Caption :=  EdicaoNFE_XPROX.AsString;
    PNLXPROX.Visible := (EdicaoNFE_XPROX.AsString <> EmptyStr);
...
begin
  ...
  try
    ...
    repeat
      ...
      if FileExists(PChar('C:\Sheild\NotaFiscal\NFe\arquivos\procnfe\' + oStrZero(ano,4) + oStrZero(mes,2) + '\' + Trim(RightStr(chNFe,44)) + '-procNFe.xml')) then
      begin
        NFE_XML := 'C:\Sheild\NotaFiscal\NFe\arquivos\procnfe\' + oStrZero(ano,4) + oStrZero(mes,2) + '\' + Trim(RightStr(chNFe,44)) + '-procNFe.xml';
        Break;
      end;
    ...
    if FileExists(PChar(NFE_XML)) then
    begin
      i := 0;
      repeat
        ...
        if FileExists(PChar('C:\Sheild\NotaFiscal\PDF\' + oStrZero(Trunc(CECDNF.Value),6) + '.pdf')) then
        begin
  ...
  if not FileExists(PChar(NFE_XML)) then
  oException(Nil,'Falha ao tentar gerar arquivo XML da danfe !');

  if not FileExists(PChar(NFE_PDF)) then
  oException(Nil,'Falha ao tentar gerar arquivo PDF da danfe !');
end;
...
procedure Tfrmven_nfe.EdicaoNFE_NCMValidate(Sender: TField);
begin
  CALCULA_CST;
end;
...
begin
  ...
  begin
    ...
    EdicaoNFE_VPROD.Value := oTextToValor(EdicaoNFE_QCOM.AsFloat * EdicaoNFE_VUNCOM.AsFloat);
  end;
...
begin
  EdicaoNFE_VPROD.Value := EdicaoNFE_QCOM.AsFloat * EdicaoNFE_VUNCOM.AsFloat;
end;

procedure Tfrmven_nfe.EdicaoNFE_VPRODValidate(Sender: TField);
begin
  if (IEFinNFe.Text <> '2') and (EDISUF.Text = EmptyStr) then
  if ((EdicaoNFE_QTRIB.AsFloat > 0) and (EdicaoNFE_VPROD.AsFloat > 0) and (EdicaoNFE_QTRIB.AsFloat <> EdicaoNFE_QCOM.AsFloat)) then
       EdicaoNFE_VUNTRIB.Value := EdicaoNFE_VPROD.AsFloat / EdicaoNFE_QTRIB.AsFloat;
end;
...
begin
  ...
  if ((EdicaoNFE_CSTIPI.AsString = '04') and (IETPNF.Text = '0')) or ((EdicaoNFE_CSTIPI.AsString = '54') and (IETPNF.Text = '1')) then
  ...
  if ((EdicaoNFE_CSTIPI.AsString = '05') and (IETPNF.Text = '0')) or ((EdicaoNFE_CSTIPI.AsString = '55') and (IETPNF.Text = '1')) then
  ...
  if ((EdicaoNFE_CSTIPI.AsString = '02') and (IETPNF.Text = '0')) or ((EdicaoNFE_CSTIPI.AsString = '52') and (IETPNF.Text = '1')) then
  ...
  if ((EdicaoNFE_CSTIPI.AsString = '49') and (IETPNF.Text = '0')) or ((EdicaoNFE_CSTIPI.AsString = '99') and (IETPNF.Text = '1')) then
...
begin
  if (IEFinNFe.Text <> '2') and (EDISUF.Text = EmptyStr) then
  EdicaoNFE_CSTIPI.Value := IFThen(EdicaoNFE_PIPI.AsFloat > 0,tab_natNAT_CSTI.AsString,tab_natNAT_CSTI0.AsString);
end;

procedure Tfrmven_nfe.EdicaoNFE_UFValidate(Sender: TField);
begin
  CALCULA_PICMS;
end;
...
//  tIde[01] := IntToStr(Random(CECDNF.Value)+1); //<cNF> Código Numérico que compõe a chNFe de Acesso - Numero aleatorio: apenas 8 digitos: NF-e 2.00
    ...
    begin
      ...
      begin
        ...
        tProd[x,047] := oTextToValor(EdicaoNFE_MVAST.AsFloat   ,4,True); //<pMVAST> Percentual da margem de valor Adicionado do ICMS ST
      ...
      tProd[x,029] := IFThen(LeftStr(EdicaoNFE_CFOP.AsString,1) = '3',oTextToValor(EdicaoNFE_VIIIMP.AsFloat  ,2,True),'');     //II   <vII>         Valor Imposto de Importação
      tProd[x,030] := IFThen(LeftStr(EdicaoNFE_CFOP.AsString,1) = '3',oTextToValor(EdicaoNFE_VIOFIMP.AsFloat ,2,True),'');     //II   <vIOF>        Valor Imposto sobre Operações Financeiras
      ...
      tProd[x,036] := IFThen(not oEmpty(EdicaoNFE_VBCOFINS.AsFloat ),oTextToValor(EdicaoNFE_VBCOFINS.AsFloat,2,True),''); //<vBC>       Valor da Base de Cálculo da COFINS
      ...
      { Tag COFINSST }
      tProd[x,057] := IFThen(not oEmpty(EdicaoNFE_VBCOFINSST.AsFloat),oTextToValor(EdicaoNFE_VBCOFINSST.AsFloat,2,True),''); //<vBC>     Valor da Base de Cálculo da COFINS
      ...
      tProd[x,060] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_NDI.AsString+';');                                    //     <nDI>         Número do Documento de Importação (DI, DSI, DIRE, ...)
      tProd[x,061] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',FormatDateTime('yyyy-mm-dd',EdicaoNFE_DDI.AsDateTime)+';');     //     <dDI>         Data de RegEdit do documento - Formato: “AAAA-MM-DD”
      tProd[x,062] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_XLOCDESEMB.AsString+';');                             //     <xLocDesemb>  Local de desembaraço
      tProd[x,063] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_UFDESEMB.AsString+';');                               //     <UFDesemb>    Sigla da UF onde ocorreu o Desembaraço Aduaneiro
      tProd[x,064] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',FormatDateTime('yyyy-mm-dd',EdicaoNFE_DDESEMB.AsDateTime)+';'); //     <dDesemb>     Data do Desembaraço Aduaneiro
      tProd[x,065] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_CEXPORTADOR.Value+';');                               //     <cExportador> Código do Exportador
      tprod[x,133] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',oTextToValor(EdicaoNFE_VAFRMM.AsFloat,2,True)+';');             //     <vAFRMM>       Valor da AFRMM - Adicional ao Frete para Renovação da Marinha Mercante
      ...
      tProd[x,066] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_NADICAO.AsString +';');                               //adi: <nAdicao>     Numero da Adição (1-1)
      tProd[x,067] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_NSEQADIC.AsString+';');                               //adi: <nSeqAdic>    Numero sequencial do item dentro da Adição (1-1)
      tProd[x,068] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_CFABRICANTE.AsString+';');                            //adi: <cFabricante> Código do fabricante estrangeiro (1-1)
      ...
      tProd[x,155] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_NDRAW.AsString+';');                                  //adi: <nDraw>        Número do ato concessório de Drawback
      ...
      begin
        ...
        tProd[x,84] := EdicaoNFE_ITEMPED.AsString; //<nItemPed> Item do Pedido de Compra (0-1)
      end;
      ...
      if (not oEmpty(EdicaoNFE_COMP.AsString)) or (not oEmpty(oREPMemoEsp(EdicaoNFE_INFADProd.AsString))) then
      if oEmpty(EdicaoNFE_COMP.AsString) then
      tProd[x,053] := LeftStr(oREPAcentos(oREPMemoEsp(EdicaoNFE_INFADPROD.AsString)),250) else
      begin
        tProd[x,053] := LeftStr(oREPAcentos(oREPMemoEsp(EdicaoNFE_COMP.AsString)),250);
        tProd[x,077] := LeftStr(oREPAcentos(oREPMemoEsp(EdicaoNFE_INFADPROD.AsString)),250);
      end;

      if not oEmpty(Trim(EdicaoNFE_INFADTRIB.AsString)) then
      if oEmpty(tProd[x,053]) then
      tProd[x,053] := Trim(EdicaoNFE_INFADTRIB.AsString) else
      tProd[x,077] := Trim(EdicaoNFE_INFADTRIB.AsString);
      ...
      tProd[x,106] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_TPVIATRANSP.AsString +';');                           //     <tpViaTransp>  NT 2013.005 1=Marítima; 2=Fluvial; 3=Lacustre; 4=Aérea; 5=Postal 6=Ferroviária; 7=Rodoviária;  8=Conduto / Rede Transmissão; 9=Meios Próprios; 10=Entrada / Saída ficta
      tProd[x,107] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_TPINTERMEDIO.AsString+';');                           //     <tpIntermedio> 1=Importação por conta própria; 2=Importação por conta e ordem; 3=Importação por encomenda;
      ...
      tprod[x,134] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_CNPJTERCEIRO.AsString+';');                           //     <CNPJ>         CNPJ do adquirente ou do encomendante
      tprod[x,135] := IFThen(LeftStr(cbcnat.Text,1) <> '3','',EdicaoNFE_UFTERCEIRO.AsString+';');                             //     <UFTerceiro>   Sigla da UF do adquirente ou do encomendante
      ...
      //tag IBSCBS
      tProd[x,249] := EdicaoNFE_CST_UB13.AsString;        // IBSCBS <CST> Código de Situação Tributária do IBS e CBS
      tProd[x,250] := EdicaoNFE_CCLASSTRIB_UB14.AsString; // IBSCBS <cClassTrib> Código de Classificação Tributária do IBS e CBS

      {Grupo de Informações do IBS e da CBS <gIBSCBS>}
      {Indexes obrigatórios: 251, 252, 258, 259, 265, 266, 267, 273}
      tProd[x,251] := oTextToValor(EdicaoNFE_VBCPIS.ASFloat,2,True); //gIBSCBS <vBC> Base de Cálculo do IBS e da CBS

      {Grupo de Informações do IBS para a UF <gIBSCBS/gIBSUF>}
      tProd[x,252] := oTextToValor(EdicaoNFE_PIS_UB06.ASFloat,4,True); // <pIBSUF> Alíquota vigente do IBS da UF
      tProd[x,258] := oTextToValor(RoundTo((EdicaoNFE_PIS_UB06.AsFloat / 100 ) * EdicaoNFE_VBCPIS.AsFloat,-2),2,True); // <vIBSUF> gIBSUF Valor do IBS de competência da UF
      ...
      tProd[x,266] := oTextToValor(RoundTO((EdicaoNFE_PIS_UB06.ASFloat / 100) * EdicaoNFE_VBCPIS.AsFloat,-2),2,True);; //gIBSCBS <vIBS> Valor do IBS

      {Grupo de informações da CBS}
      tProd[x,267] := oTextToValor(EdicaoNFE_PIBS_UB18.AsFloat,4,True);                                                // <pCBS> gCBS Alíquota da CBS
      tProd[x,273] := oTextToValor(RoundTO((EdicaoNFE_PIBS_UB18.AsFloat / 100) * EdicaoNFE_VBCPIS.AsFloat,-2),2,True); // <vCBS> Valor da CBS
    ...
    if oTrimValor(EDvICMSUFDest.Text) > 0 then
    tTotal[35] := oTextToValor(EDvICMSUFDest.Text,2,True); //ICMSTot <vICMSUFDest>
    ...
    tTotal[49] := oTextToValor(EdicaoNFE_VBCPIS.ASFloat,2,True); //<vBCIBSCBS> Valor total da BC do IBS e da CBS
    ...
    tTotal[52] := oTextToValor(RoundTo((EdicaoNFE_PIS_UB06.AsFloat  / 100) * EdicaoNFE_VBCPIS.AsFloat,-2),2,True); //<vIBSUF> Valor total do IBS da UF
    ...
    tTotal[56] := oTextToValor(RoundTo((EdicaoNFE_PIS_UB06.AsFloat / 100) * EdicaoNFE_VBCPIS.AsFloat,-2),2,True); //<vIBS> Valor total do IBS
    ...
    tTotal[61] := oTextToValor(RoundTO((EdicaoNFE_PIBS_UB18.AsFloat / 100) * EdicaoNFE_VBCPIS.AsFloat,-2),2,True); //<vCBS> Valor total da CBS
    ...
    chNFe := GeraNFe(tIde,tEmit,tDest,tProd,tTotal,tTransp,tCobr,tPag,tInfAdic,autXML,False);
...
begin
  if EdicaoNFE_CCAB.AsInteger <> 99999 then
     EdicaoNFE_PICMS.Value := IFThen((Pos(EdicaoNFE_CST.AsString,'201202500900') = 0) and (RECParametros.NFE_CRT = 1),0,
                               ...
                               IFThen((Pos(EdicaoNFE_ORIG.AsString,'12') > 0) and (PEUF.Text <> RECParametros.LOG_UF),4,
                               IFThen((PEUF.Text = RECParametros.LOG_UF        ) and (PEUF.Text = 'SP') and (EdicaoNFE_NCM.AsString = '39181000'),12,tab_alqALQ_ICMS.AsFloat))));
end;

procedure Tfrmven_nfe.CALCULA_CST;
begin
  if (EdicaoNFE_CFOP.AsString <> TAB_NATNAT_CNAT.AsString) and
     (EdicaoNFE_CFOP.AsString <> EmptyStr) then
  ...
  begin
    ...
    SQL.Clear;
    SQL.Add('SELECT * FROM TAB_NAT');
    SQL.Add('WHERE  NAT_CNAT = ''' + EdicaoNFE_CFOP.AsString + '''');
    Open;
  end;

  EdicaoNFE_CSTIPI.Value    := IFThen(EdicaoNFE_PIPI.AsFloat > 0,tab_natNAT_CSTI.AsString,tab_natNAT_CSTI0.AsString);
  EdicaoNFE_CSTPIS.Value    := tab_natNAT_CSTP.AsString;
  EdicaoNFE_PPIS.Value      := IFThen(RECParametros.REGIME = 'LR',tab_natNAT_PIPP_REAL.AsFloat,
                               IFThen(RECParametros.REGIME = 'SN',tab_natNAT_PIPP_SIM.AsFloat ,tab_natNAT_PIPP.AsFloat));
  EdicaoNFE_CSTCOFINS.Value := tab_natNAT_CSTC.AsString;
  EdicaoNFE_PCOFINS.Value   := IFThen(RECParametros.REGIME = 'LR',tab_natNAT_PIPC_REAL.AsFloat,
                               IFThen(RECParametros.REGIME = 'SN',tab_natNAT_PIPC_SIM.AsFloat ,tab_natNAT_PIPC.AsFloat));
  EdicaoNFE_INDTOT.Value    := tab_natNAT_INDT.AsInteger;
  EdicaoNFE_FRET.Value      := tab_natNAT_FRET.AsString;
  EdicaoNFE_TIPO.Value      := tab_natNAT_TIPO.AsString;

  if RECParametros.NFE_CRT = 3 then
  begin
    EdicaoNFE_CST.Value := TAB_NATNAT_CCST.AsString;
  ...
  begin
    { SIMPLES NACIONAL }
    EdicaoNFE_CST.Value := tab_natNAT_CSTS.AsString;
    ...
    EdicaoNFE_CST.Value := tab_natNAT_CSTA.AsString;
  end;
  ...
  { REFORMA TRIBUTÁRIA }
  { IS }
  EdicaoNFE_CSTIS_UB02.Value        := TAB_NATCSTIS.AsString;
  EdicaoNFE_CCLASSTRIBIS_UB03.Value := TAB_NATCCLASSTRIBIS.AsString;
  EdicaoNFE_PIS_UB06.Value          := TAB_NATPIS.AsCurrency;

  { CBS }
  EdicaoNFE_CST_UB13.Value        := TAB_NATCSTCBS.AsString;
  EdicaoNFE_CCLASSTRIB_UB14.Value := TAB_NATCCLASSTRIBCBS.AsString;
  EdicaoNFE_PIBS_UB18.Value       := TAB_NATPCBS.AsCurrency;
end;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          if EdicaoNFE_CFOP.AsString <> tab_natNAT_CNAT.AsString then
          with tab_nat do
          begin
            Close;
            SQL.Clear;
          ...
          begin
            ...
            EdicaoNFE_MVAST.Value          := 0;
            EdicaoNFE_VI04.Value           := 0;
            EdicaoNFE_VI07.Value           := 0;
            EdicaoNFE_VI12.Value           := 0;
            EdicaoNFE_VI18.Value           := 0;
            EdicaoNFE_MODBCST.Value        := '';
            ...
            begin
              ...
              begin
                ...
                EdicaoNFE_VBCOFINS.Value := IFThen(Pos(EdicaoNFE_CST.AsString,'49201202203') > 0,0,EdicaoNFE_VBC.AsFloat);
              end else
              begin
                EdicaoNFE_PPIS.Value    := 0;
                EdicaoNFE_PCOFINS.Value := 0;
              ...
              EdicaoNFE_VCOFINS.Value := RoundTO((EdicaoNFE_VBCOFINS.AsFloat * EdicaoNFE_PCOFINS.AsFloat) / 100,-2);
              ...
              begin
                ...
                EdicaoNFE_VBCOFINS.Value := EdicaoNFE_VBCIMP.AsFloat;
              end;
              ...
              begin
                ...
                begin
                  ...
                  if (EdicaoNFE_PICMS.AsFloat = 4)  and (EdicaoNFE_VI04.AsFloat > 0) then
                  begin
                    EdicaoNFE_MVAST.Value := EdicaoNFE_VI04.AsFloat;
                    EdicaoNFE_VBCST.Value := EdicaoNFE_VPROD.AsFloat + EdicaoNFE_VIPI.AsFloat    + EdicaoNFE_VFRETE.AsFloat + EdicaoNFE_VSEG.AsFloat;
                    EdicaoNFE_VBCST.Value := EdicaoNFE_VBCST.AsFloat + ((EdicaoNFE_VBCST.AsFloat * EdicaoNFE_VI04.AsFloat)/100);
                  end else
                  if (EdicaoNFE_PICMS.AsFloat = 7) and (EdicaoNFE_VI07.AsFloat > 0) then
                  begin
                    EdicaoNFE_MVAST.Value := EdicaoNFE_VI07.AsFloat;
                    EdicaoNFE_VBCST.Value := EdicaoNFE_VPROD.AsFloat + EdicaoNFE_VIPI.AsFloat    + EdicaoNFE_VFRETE.AsFloat + EdicaoNFE_VSEG.AsFloat;
                    EdicaoNFE_VBCST.Value := EdicaoNFE_VBCST.AsFloat + ((EdicaoNFE_VBCST.AsFloat * EdicaoNFE_VI07.AsFloat)/100);
                  end else
                  if (EdicaoNFE_PICMS.AsFloat = 12) and (EdicaoNFE_VI12.AsFloat > 0) then
                  begin
                    EdicaoNFE_MVAST.Value := EdicaoNFE_VI12.AsFloat;
                    EdicaoNFE_VBCST.Value := EdicaoNFE_VPROD.AsFloat + EdicaoNFE_VIPI.AsFloat    + EdicaoNFE_VFRETE.AsFloat + EdicaoNFE_VSEG.AsFloat;
                    EdicaoNFE_VBCST.Value := EdicaoNFE_VBCST.AsFloat + ((EdicaoNFE_VBCST.AsFloat * EdicaoNFE_VI12.AsFloat)/100);
                  end else
                  if (EdicaoNFE_PICMS.AsFloat = 18) and (EdicaoNFE_VI18.AsFloat > 0) then
                  begin
                    EdicaoNFE_MVAST.Value := EdicaoNFE_VI18.AsFloat;
                    EdicaoNFE_VBCST.Value := EdicaoNFE_VPROD.AsFloat + EdicaoNFE_VIPI.AsFloat    + EdicaoNFE_VFRETE.AsFloat + EdicaoNFE_VSEG.AsFloat;
                    EdicaoNFE_VBCST.Value := EdicaoNFE_VBCST.AsFloat + ((EdicaoNFE_VBCST.AsFloat * EdicaoNFE_VI18.AsFloat)/100);
                  end;

                  if EdicaoNFE_MVAST.AsFloat > 0 then
                  begin
                ...
                begin
                  EdicaoNFE_CFOP.Value    := IFThen(IETPNF.Text = '0','2411',
                ...
                if RECParametros.NFE_REDUCAO_PISCOFINS then
                   if ((IETPNF.Text = '1') or (Pos(cbcnat.Text,'1201120222012202') > 0)) and (EdicaoNFE_VBCPIS.AsFloat > 0) and (EdicaoNFE_VBCOFINS.AsFloat > 0) and (EdicaoNFE_VICMS.AsFloat > 0) then
                   begin
                     { REDUÇÃO PIS}
                     ...
                     { REDUÇÃO COFINS }
                     EdicaoNFE_VBCOFINS.Value:= EdicaoNFE_VBCOFINS.AsFloat - EdicaoNFE_VICMS.AsFloat;
                     EdicaoNFE_VCOFINS.Value := RoundTO((EdicaoNFE_VBCOFINS.AsFloat * EdicaoNFE_PCOFINS.AsFloat) / 100,-2);
                   end;
              end;
              ...
              begin
                ...
                begin
                  ...
                  if (RECParametros.NFE_CREDITO_ICMS > 0) and (IECredICMS.Text = '1') then
                     if (LeftStr(EdicaoNFE_CFOP.AsString,4) = '5101') or (LeftStr(EdicaoNFE_CFOP.AsString,4) = '5102') or
                        (LeftStr(EdicaoNFE_CFOP.AsString,4) = '6101') or (LeftStr(EdicaoNFE_CFOP.AsString,4) = '6102') or
                        (LeftStr(EdicaoNFE_CFOP.AsString,4) = '5124') or (LeftStr(EdicaoNFE_CFOP.AsString,4) = '6124') or
                        (LeftStr(EdicaoNFE_CFOP.AsString,4) = '5125') or (LeftStr(EdicaoNFE_CFOP.AsString,4) = '5925') or
                        (LeftStr(EdicaoNFE_CFOP.AsString,4) = '6107') or (LeftStr(EdicaoNFE_CFOP.AsString,4) = '6108') then
                     begin
                       EdicaoNFE_CST.Value           := tab_natNAT_CSTA.AsString;
                ...
                if EdicaoNFE_CST.Value = '900' then
                begin
                  EdicaoNFE_VBCCREDICMSSN.Value := 0;
                  EdicaoNFE_PCREDSN.Value       := 0;
                  EdicaoNFE_VCREDICMSSN.Value   := 0;
