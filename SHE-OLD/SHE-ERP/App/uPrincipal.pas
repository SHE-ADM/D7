...
begin
  ...
  try
    ...
    { Coleções }
    AREC_SHE_DEF.GDescricao    := 'Produtos'; AREC_SHE_DEF.GReferencia := 'Tabela de Coleções'; AREC_SHE_DEF.GRegra := 'Permissões Gerais'; oUSER(AREC_SHE_DEF);
    ACTCAD_PRO_COL.Enabled     := AREC_SHE_DEF.GView;

    { Segmentos }
    AREC_SHE_DEF.GDescricao    := 'Produtos'; AREC_SHE_DEF.GReferencia := 'Tabela de Segmentos'; AREC_SHE_DEF.GRegra := 'Permissões Gerais'; oUSER(AREC_SHE_DEF);
    ACTCAD_PRO_SEG.Enabled     := AREC_SHE_DEF.GView;

    { Grupos }
    AREC_SHE_DEF.GDescricao    := 'Produtos'; AREC_SHE_DEF.GReferencia := 'Tabela de Grupos'; AREC_SHE_DEF.GRegra := 'Permissões Gerais'; oUSER(AREC_SHE_DEF);
    ACTCAD_PRO_GRP.Enabled     := AREC_SHE_DEF.GView;
    ACTCAD_PRO_SGP.Enabled     := AREC_SHE_DEF.GView;

    { Sub Grupos }
    AREC_SHE_DEF.GDescricao    := 'Produtos'; AREC_SHE_DEF.GReferencia := 'Tabela de Sub Grupos'; AREC_SHE_DEF.GRegra := 'Permissões Gerais'; oUSER(AREC_SHE_DEF);
    ACTCAD_PRO_GRP.Enabled     := AREC_SHE_DEF.GView;
    ACTCAD_PRO_SGP.Enabled     := AREC_SHE_DEF.GView;

    { Categorias }
    AREC_SHE_DEF.GDescricao    := 'Produtos'; AREC_SHE_DEF.GReferencia := 'Tabela de Categorias'; AREC_SHE_DEF.GRegra := 'Permissões Gerais'; oUSER(AREC_SHE_DEF);
    ACTCAD_PRO_CAT.Enabled     := AREC_SHE_DEF.GView;
    ACTCAD_PRO_SCT.Enabled     := AREC_SHE_DEF.GView;

    { Sub Categorias }
    AREC_SHE_DEF.GDescricao    := 'Produtos'; AREC_SHE_DEF.GReferencia := 'Tabela de Sub Categorias'; AREC_SHE_DEF.GRegra := 'Permissões Gerais'; oUSER(AREC_SHE_DEF);
    ACTCAD_PRO_CAT.Enabled     := AREC_SHE_DEF.GView;
    ACTCAD_PRO_SCT.Enabled     := AREC_SHE_DEF.GView;
