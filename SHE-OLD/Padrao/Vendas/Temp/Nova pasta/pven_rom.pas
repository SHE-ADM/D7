  ...
  try
    ...
    begin
      ...
      begin
        ...
        EdicaoNFE_UQTDE.Value := SQLFKConsulta.Current.ByName('UQTDE').AsFloat;

        EdicaoNFE_QCOM.Value := SQLFKConsulta.Current.ByName('ROM_QTDE').Value;
        EdicaoNFE_RCOM.Value := SQLFKConsulta.Current.ByName('ROM_QTRL').AsInteger;

        EdicaoNFE_VUNPAD.Value := SQLFKConsulta.Current.ByName('VUNCOM').Value;
        EdicaoNFE_VUNCOM.Value := SQLFKConsulta.Current.ByName('VUNCOM').Value;

        EdicaoNFE_VPROD.Value := SQLFKConsulta.Current.ByName('TCDE').Value;
