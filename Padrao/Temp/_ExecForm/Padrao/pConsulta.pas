...
procedure TFrmConsulta._WM_CREATE(var Msg: TMessage);
begin
...
procedure TFrmConsulta._WM_AFTER_CREATE(var Msg: TMessage);
begin
  { FORM SCREEN }
...
procedure TFrmConsulta._WM_ACTIVATE(var Msg: TMessage);
begin
  { EVENTOS }
  ACTEveRegister.Execute;
end;

procedure TFrmConsulta._SW_SHOWNOACTIVATE(var Msg: TMessage);
...
procedure TFrmConsulta._WM_SHOW(var Msg: TMessage);
begin
  { INICIALIZA FORM SCREEN }
...
procedure TFrmConsulta._WM_AFTER_SHOW(var Msg: TMessage);
begin
...
procedure TFrmConsulta._WM_RESIZE(var Message: TMessage);
begin
  { Before Resize }
...
procedure TFrmConsulta._WM_AFTER_RESIZE(var Message: TMessage);
begin
  { After Resize }
...
procedure TFrmConsulta.FormCloseQuery(Sender: TObject; var CanClose: Boolean);
begin
  { VER ANTES DE SAIR }
end;
...
procedure TFrmConsulta.ACTEveRegisterExecute(Sender: TObject);
begin
  { UNREGISTER EVENTS }
  if EEvent.Registered then
     try
...
procedure TFrmConsulta.ACTEveExecuteExecute(Sender: TObject);
var
  i: word;
begin
  if REC_SHE_DEF.FB_Event = EmptyStr then
...
procedure TFrmConsulta.ACTConsultaExecute(Sender: TObject);
begin
...
procedure TFrmConsulta.ACTMPAppendExecute(Sender: TObject);
begin
  if not ALockWindowUpdate then { SQL Injection }
  oAppend(Cadastro,REC_SHE_DEF.GAppend);
end;

procedure TFrmConsulta.ACTMPEditExecute(Sender: TObject);
begin
  if not ALockWindowUpdate then { SQL Injection }
  oEdit(Cadastro,REC_SHE_DEF.GEdit);
end;

procedure TFrmConsulta.ACTMPDeleteExecute(Sender: TObject);
begin
  if not ALockWindowUpdate then { SQL Injection }
  oDelete(Cadastro,REC_SHE_DEF.GDelete);
end;

procedure TFrmConsulta.ACTMPPostExecute(Sender: TObject);
begin
  if not ALockWindowUpdate then { SQL Injection }
  oPost(Cadastro);
end;

procedure TFrmConsulta.ACTMPCancelExecute(Sender: TObject);
begin
  if not ALockWindowUpdate then { SQL Injection }
  oCancel(Cadastro);
end;

procedure TFrmConsulta.ACTEveExpressExecute(Sender: TObject);
begin
  ACTEveRegister.Execute;
  ACTEveExecute.Execute;
end;

procedure TFrmConsulta.ACTProgressBarExecute(Sender: TObject);
begin
  ActiveControl := Nil;
end;

procedure TFrmConsulta.ACTDashboardsExecute(Sender: TObject);
begin
  ActiveControl := Nil;
end;

procedure TFrmConsulta.ACTCheckConstraintsExecute(Sender: TObject);
begin
  ActiveControl := Nil;
end;

procedure TFrmConsulta.ACTCheckErrorsExecute(Sender: TObject);
begin
  ActiveControl := Nil;
end;
...
procedure TFrmConsulta.ACTEdicaoExecute(Sender: TObject);
begin
  { INICIALIZAÇÃO DE TRANSAÇÕES }
end;
...
procedure TFrmConsulta.CadastroCalcFields(DataSet: TDataSet);
begin
  CadastroC_ID.Value := Cadastro.RecNo;
end;

procedure TFrmConsulta.DTSCadastroDataChange(Sender: TObject;
  Field: TField);
begin
  { nothing }
end;

procedure TFrmConsulta.DTSCadastroStateChange(Sender: TObject);
begin
  { nothing }
end;
...
procedure TFrmConsulta.DBGConsultaCustomDrawCell(Sender: TObject;
