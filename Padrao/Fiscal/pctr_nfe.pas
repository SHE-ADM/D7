...
begin
  ...
  begin
    ...
    SQL.Add('WHERE    CAST(PK.DTCA AS DATE) BETWEEN ''' + FormatDateTime('mm/dd/yy',RECParametros.SHE_DATA_MES_PK) + ''' AND ''' + FormatDateTime('mm/dd/yy',RECParametros.SHE_DATA_MES_FK) + '''');
