...
procedure TFrmRelatorios_OLD.ACTPROSpedFiscalExecute(Sender: TObject);
begin
...
procedure TFrmRelatorios_OLD.ACTGER_CRDExecute(Sender: TObject);
begin
...
procedure TFrmRelatorios_OLD.ACTGerencial_Estoque_Unidade_MedidaExecute(Sender: TObject);
begin
...
procedure TFrmRelatorios_OLD.ACTGerencial_NF_PesoExecute(Sender: TObject);
begin
...
//  IEEmpresa.Text    := IFThen(IEEmpresa.Enabled,'TODAS AS EMPRESAS',RECParametros.EP_NO);
  ...
  case RECRelatorios.Perfil of
   ...
   14: begin
         ...
         {RICARDO  if (RECParametros.EP_GE <> EmptyStr) and (IEEmpresa.Enabled) then
           begin
