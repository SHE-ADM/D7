...
uses
  ...
  dxDockControl, dxDockPanel, ActnList;
  ...
  try
    ...
    try
      ...
      begin
        ...
        SPEdicao.ParamByName('ADTPK').Value      := RECParametros.DTServer;
      ...
      begin
        ...
        SQL.Add('      ROM_DCAN = ''' + FormatDateTime('mm/dd/yy',RECParametros.DTServer) + ''',');
